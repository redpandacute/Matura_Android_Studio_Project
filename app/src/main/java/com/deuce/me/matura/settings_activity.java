...
public class settings_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savechanges_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(newpassword_et.getText().toString().isEmpty()) {
                    ...
                    savesettings_pw_request save_request = new savesettings_pw_request(id, surname, name, email, school, description, oldpassword, newpassword,
                                                                                        german, spanish, english, french, biology, chemics, music, maths, physics,
                                                                                        response_listener);
