...
public class register_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //yearofbirth Spinner adding Years
        ...
        yearofbirth_sp.setAdapter(year_spinner_adp);
        year_spinner_adp.notifyDataSetChanged();


        registerbutton_bu.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (password.equals(confpassword)) {
                    if (termsofservice_cb.isChecked() && !username.isEmpty() && !name.isEmpty() && !surname.isEmpty() /*&& !school.isEmpty() */ && !email.isEmpty() && !password.isEmpty()){
                        ...
                        //Creating Request
                        register_request reg_request = new register_request(username, name, surname, school, yearofbirth,email, password, response_listener);
