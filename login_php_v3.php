<?php
	...
	$statement = mysqli_prepare($conn, "SELECT user_archive.*, user_hashes.*
		FROM user_archive 
	...
	if(mysqli_stmt_num_rows($statement) > 0) {
		...
		mysqli_stmt_bind_result($statement, $id, $username, $name, $firstname, $school, $grade, $email, $description, 
		...
		if(strcmp($hash_password, $check['hash_password']) == 0) {
